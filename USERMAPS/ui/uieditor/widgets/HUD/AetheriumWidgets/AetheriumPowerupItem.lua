-- Aetherium Powerup Item Widget
-- Individual powerup icon with timer display

CoD.AetheriumPowerupItem = InheritFrom( LUI.UIElement )
CoD.AetheriumPowerupItem.new = function ( menu, controller )
	local self = LUI.UIElement.new()

	self:setUseStencil( false )
	self:setClass( CoD.AetheriumPowerupItem )
	self.id = "AetheriumPowerupItem"
	self.soundSet = "HUD"
