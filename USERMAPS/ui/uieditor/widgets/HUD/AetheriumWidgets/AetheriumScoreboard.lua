...
CoD.AetheriumScoreboard.new = function ( menu, controller )
	...
	self.game_mode_text:setTTF( "fonts/ltromatic.ttf" )
	...
	self.map_name_text:setTTF( "fonts/ltromatic.ttf" )
	...
	self.round_label:setTTF( "fonts/ltromatic.ttf" )
	...
	self.round_number:setTTF( "fonts/ltromatic.ttf" )
	...
	for playerIndex = 0, 3 do
		...
		playerRow.id_text:setTTF( "fonts/ltromatic.ttf" )
		...
		playerRow.level_text:setTTF( "fonts/ltromatic.ttf" )
		...
		playerRow.points_text:setTTF( "fonts/ltromatic.ttf" )
		...
		playerRow.kills_text:setTTF( "fonts/ltromatic.ttf" )
		...
		playerRow.headshots_text:setTTF( "fonts/ltromatic.ttf" )
		...
		playerRow.downs_text:setTTF( "fonts/ltromatic.ttf" )
		...
		playerRow.revives_text:setTTF( "fonts/ltromatic.ttf" )
